...
var textChangeHandler_1 = require("./handlers/textChangeHandler");
var aiTracker_1 = require("./core/aiTracker");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, employeeService_1.initEmployee)(context)];
                case 1:
                    _a.sent();
                    context.subscriptions.push(vscode.workspace.onDidChangeTextDocument(textChangeHandler_1.handleTextChange));
